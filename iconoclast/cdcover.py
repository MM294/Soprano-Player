# Written by Michael Morley 2011
# Code based on that from Decibel Player by François Ingelrest 
import urllib2, os
...
#Debugging stuff and example usage below this, comment out or delete when used in an app
coverFetch = getCover()
# the album and artist must have whitespace replaced by %20 for url purposes
img = coverFetch.returnCover('Symphony%20X', 'The%20Divine%20Wings%20of%20Tragedy', '/media/Media/Music/Babyshambles/Down In Albion2/2 - Fuck Forever.mp3')
