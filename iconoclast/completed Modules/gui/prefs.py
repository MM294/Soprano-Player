...
class SopranoPrefWin:
	def __init__(self):
		...
		for key, value in self.audioFolderlist.get_radioStations().iteritems():
		...
		line3HBox.pack_start(line3Button1, True, True, 0)
		line3HBox.pack_start(line3Button2, True, True, 0)
		#Line 3
		hbox = Gtk.HBox()
		...
		vbox.pack_start(line3HBox, False, True, 0)
		vbox.pack_start(hbox, False, True, 0)
	
		self.win = PrefWin.PrefWin()
		self.win.create_category("Desktop", "folder", vbox)
